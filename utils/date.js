function getDayOfTheWeek(utcDate) {
    // Pentru a crea o data dintr-o valoare utc trebuie sa o inmutim cu 1000
    ...
    switch (dayIndex) {
        ...
        case 6:
            ...
            break;
        default:
            // afisam o eroarea daca index-ul nu este valid (nu ar trebui sa se ajunga aici deoarece OpenWeather intoarce zilele saptamanii corect)
